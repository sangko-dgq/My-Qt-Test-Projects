...
void lv_ex_list_1(void)
{
    ...
    lv_obj_set_style_local_bg_color(list1, LV_PAGE_PART_BG, LV_STATE_DEFAULT, LV_COLOR_SILVER);
    ...
    lv_obj_set_style_local_bg_color(list_btn, LV_PAGE_PART_BG, LV_STATE_DEFAULT, LV_COLOR_SILVER);
