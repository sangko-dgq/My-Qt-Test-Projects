...
static void launcher_icon_create(lv_obj_t * par)
{
    ...
    for(i = 0;i < MAX_ICON_NUM - i_launcher_sta_icon;i++)
    {
        ...
        lv_obj_set_style_local_text_font(icon_name[i],LV_LABEL_PART_MAIN,LV_STATE_DEFAULT,&myFont12);
    ...
    lv_tabview_set_tab_act(launcher_tab_icon, 1, LV_ANIM_OFF);
...
static void launcher_static_icon_create(lv_obj_t * par)
{
    ...
    for(i=0;i<i_launcher_sta_icon;i++)
    {
        ...
        lv_obj_set_style_local_text_font(icon_name[MAX_ICON_NUM - i_launcher_sta_icon + i],LV_LABEL_PART_MAIN,LV_STATE_DEFAULT,&myFont12);
