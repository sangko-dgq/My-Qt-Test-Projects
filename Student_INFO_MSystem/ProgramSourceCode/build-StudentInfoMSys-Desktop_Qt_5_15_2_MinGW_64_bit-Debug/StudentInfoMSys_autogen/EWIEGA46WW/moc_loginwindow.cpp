...
#include <memory>
#include "../../../StudentInfoMSys/loginwindow.h"
...
void LoginWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sg_sendLoginSuccess(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginWindow::sg_sendLoginSuccess)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LoginWindow::sg_sendLoginSuccess()
{
